        ...
        <div className="flex md:flex-row flex-col gap-4 md:gap-6">
          ...
          <div className="md:h-full md:overflow-y-auto pb-4 md:pb-8">
            <div className="flex-col gap-4 flex md:gap-6">
              ...
              <div className={`rounded-xl md:rounded-2xl p-4 md:p-6 shadow-xl ${isLightMode ? 'bg-white/70 border border-blue-200' : 'bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur border border-slate-700/50'}`}>
                <div
                  className="flex justify-between items-center mb-4 md:mb-6 cursor-pointer"
                  onClick={() => {
                    if (isRunning) {
              ...
              <div className={`rounded-xl md:rounded-2xl p-4 md:p-6 shadow-xl ${isLightMode ? 'bg-gradient-to-br from-purple-100 via-pink-100 to-rose-100 border border-purple-300' : 'bg-gradient-to-br from-purple-500/10 via-pink-500/10 to-rose-500/10 backdrop-blur border border-purple-500/30'}`}>
                ...
                <div className={`rounded-lg md:rounded-xl p-4 md:p-6 mb-4 md:mb-6 ${isLightMode ? 'bg-blue-50 border border-blue-200' : 'bg-slate-950/70 backdrop-blur border border-purple-500/20'}`}>
                  <p className={`text-xl md:text-3xl text-center font-mono font-bold ${isLightMode ? 'bg-gradient-to-r from-emerald-600 via-cyan-600 to-blue-600 bg-clip-text text-transparent' : 'bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent'}`}>
